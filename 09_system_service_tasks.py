...
try:
    ...
    logging.error(f"Error importando dependencias de servicios: {e}")
...
from .04_base_classes import BaseTask, TaskPriority, TaskStatus
from .05_detailed_system_task import wmi_manager

# Logger para este módulo
logger = logging.getLogger('SystemMonitor.SystemServiceTasks')
...
class StartupProgramsTask(BaseTask):
    ...
    def execute(self) -> Dict[str, Any]:
        ...
        try:
            ...
            logger.error(f"Error en análisis de programas de inicio: {e}")
            raise
