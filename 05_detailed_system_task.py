...
try:
    ...
    logging.error(f"Error importando dependencias WMI: {e}")
...
logger = logging.getLogger('SystemMonitor.DetailedSystemTask')
    ...
    def get_connection(self) -> Optional[wmi.WMI]:
        ...
        with self._lock:
            try:
                ...
                logger.error(f"Error estableciendo conexión WMI: {e}")
                self._connection = None
                return None
...
class DetailedSystemInfoTask(BaseTask):
    ...
    def execute(self) -> Dict[str, Any]:
        ...
        try:
            ...
            logger.error(f"Error crítico en análisis detallado: {e}\n{traceback.format_exc()}")
            raise
