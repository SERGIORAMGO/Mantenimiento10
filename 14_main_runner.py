...
try:
    from module_01_config_and_imports import SystemConfig, SystemConstants
    from module_02_utilities import SystemUtilities, FileUtilities, SecurityUtilities
    from module_11_main_interface import SystemMonitorInterface, create_system_monitor
    from module_12_gui_interface import SystemMonitorGUI
    from module_13_cli_interface import SystemMonitorCLI, Colors
except ImportError as e:
    print(f"Error crítico importando módulos: {e}")
    print("Asegúrese de que todos los módulos están en el directorio correcto")
    sys.exit(1)
...
class SystemMonitorRunner:
    ...
    def setup_logging(self, log_level: str = "INFO", log_file: str = None, 
        ...
        try:
            ...
            self.logger = logging.getLogger('SystemMonitor.Runner')
