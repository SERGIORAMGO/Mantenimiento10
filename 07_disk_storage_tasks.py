...
try:
    ...
    logging.error(f"Error importando dependencias de disco: {e}")
...
logger = logging.getLogger('SystemMonitor.DiskStorageTasks')
...
class DiskAnalysisTask(BaseTask):
    ...
    def execute(self) -> Dict[str, Any]:
        ...
        try:
            ...
            logger.error(f"Error en análisis de discos: {e}")
            raise
