...
class SystemConfig:
    ...
    APP_NAME = "Sistema de Monitoreo de PC"
    APP_VERSION = "3.0.0"
    ...
    LOG_FILE = LOGS_DIR / f"system_monitor_{datetime.datetime.now().strftime('%Y%m%d')}.log"
...
def setup_logging():
    ...
    try:
        ...
        app_logger = logging.getLogger('SystemMonitor')
...
def cleanup_temp_files():
    ...
    try:
        ...
        logging.getLogger('SystemMonitor').warning(f"Error limpiando archivos temporales: {e}")
